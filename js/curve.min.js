 ...
 */
//CanvasRenderingContext2D.prototype.curve = CanvasRenderingContext2D.prototype.curve || function(ctx, created, points, tension, numOfSeg, close) {
function createLine(created, points, tension, numOfSeg, close) {
	'use strict';
	...
	if(!created){
		...
		mySVG.setAttributeNS(null,"id","mySVG");
		mySVG.setAttributeNS(null,"preserveAspectRatio","none");
		mySVG.setAttributeNS(null,"width","100%");
		mySVG.setAttributeNS(null,"height","300");
		mySVG.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:xlink", "http://www.w3.org/1999/xlink");
		document.getElementById("svgHolder").appendChild(mySVG);

		//create and append line
		var svgNS = "http://www.w3.org/2000/svg";
		var myLine = document.createElementNS(svgNS,"path");
		myLine.setAttributeNS(null,"id","myLine");
		myLine.setAttributeNS(null, "d", svgPath);
		myLine.setAttributeNS(null, "stroke", "black"); 
		myLine.setAttributeNS(null, "stroke-width", 3);  
		myLine.setAttributeNS(null, "opacity", 1);  
		myLine.setAttributeNS(null, "fill", "none");
		document.getElementById("mySVG").appendChild(myLine);
	}
	
	if(created){
		//change path on resize
